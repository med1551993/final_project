...
const Reservations = ({setshowsignin,showsignin,setshowsignup,showsignup}) => {
const [showprofile, setshowprofile] = useState(false);
  return (
    <div className="carte">

      <div className="conducteur">
        <img src={med} onClick={() => setshowprofile(true)} />
      ...
      <div className="options">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="active"> 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="active" >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="non-active">
